...
namespace BizHawk.Client.Common
{
	public sealed class JoypadLuaLibrary : LuaLibraryBase
	{
		...
		public void Set([LuaASCIIStringParam] LuaTable buttons, int? controller = null)
		{
		...
		public void SetAnalog([LuaASCIIStringParam] LuaTable controls, int? controller = null)
		{
