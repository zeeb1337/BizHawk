...
namespace BizHawk.Client.EmuHawk
{
	public partial class GenericCoreConfig : Form
	{
		...
		public static void DoDialog(IEmulator emulator, IDialogParent owner, string title, bool isMovieActive)
		{
		...
		public static void DoDialogFor(
			...
			bool isMovieActive)
		{
			using GenericCoreConfig dlg = new(settable, isMovieActive)
			{
				Text = title,
			};
			owner.ShowDialogAsChild(dlg);
